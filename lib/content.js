export const NAV = [
  { id: "brand", no: "01", label: "브랜드" },
  { id: "why", no: "02", label: "왜 지금인가" },
  { id: "process", no: "03", label: "발효 공정" },
  { id: "design", no: "04", label: "향미 설계" },
  { id: "flavor", no: "05", label: "라인업" },
  { id: "local", no: "06", label: "지역 상생" },
  { id: "product", no: "07", label: "제품" },
  { id: "proof", no: "08", label: "검증" },
  { id: "roadmap", no: "09", label: "로드맵" },
];
...
export const EDITIONS = [
  { r: "Jeju", t: "제주의 감귤커피", d: "감귤 발효 · 시트러스 아로마", img: "/img/pkg-jeju.webp" },
  { r: "Nonsan", t: "논산의 딸기커피", d: "딸기 발효 · 선명한 산미", img: "/img/pkg-nonsan.webp" },
  { r: "Wonju", t: "원주의 복숭아커피", d: "복숭아 발효 · 부드러운 단맛", img: "/img/pkg-wonju.webp" },
];
