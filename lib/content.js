...
export const EDITIONS = [
  { r: "Jeju", t: "제주의 감귤커피", d: "감귤 발효 · 시트러스 아로마", img: "/img/crop/pkg-jeju.webp", bg: "linear-gradient(#fffce9, #fffff9)" },
  { r: "Nonsan", t: "논산의 딸기커피", d: "딸기 발효 · 선명한 산미", img: "/img/crop/pkg-nonsan.webp", bg: "linear-gradient(#fff3db, #fff4f0)" },
  { r: "Wonju", t: "원주의 복숭아커피", d: "복숭아 발효 · 부드러운 단맛", img: "/img/crop/pkg-wonju.webp", bg: "linear-gradient(#ffe9d0, #fdf0ee)" },
];
