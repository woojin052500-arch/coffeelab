...
export const QUESTIONS = [
  {
    ...
    a: [
      { t: "상큼하고 청량한 과일 에이드", e: { acid: 2 } },
      { t: "고소하고 부드러운 우유나 라떼", e: { body: 2 } },
    ],
  },
  {
    q: "내가 선호하는 과일 취향은?",
